...
while {$conti == 1} {
	...
	event generate .t7 <Motion> -warp 1 -x [expr $x_pos+3-10] -y [expr $y_pos+3-10];	
	update;
	...
	update
	set counter1 0
	while {$conti == 1 && $counter1 < 10000} {after 100;
		incr counter1 1; .t7.b configure -text $counter1; update;}
      if {$x_pos == 52} {set x_pos 2; set y_pos 1;}
		#/n:c @aargh!!!
}
