...
pack .f4; pack .f4.4 -side left;pack .f4.4on -side right;pack .f4.4off -side right
...
pack .f5; pack .f5.5 -side left;pack .f5.5on -side right;pack .f5.5off -side right
#
#1
...
frame .frame2; pack .frame2 -side left
button .frame2.but1 -text but1 -command {puts im$i; tree$i $i}; pack .frame2.but1
frame .frame1; pack .frame1 -side right
button .frame1.no -text yes -command {puts "aargh hoops"}; pack .frame1.no -side right
button .frame1.yes -text no -command {puts xx.max; exit}; pack .frame1.yes -side right
frame .frame3; pack .frame3 -side bottom
button .frame3.but1 -text +-O -command {puts "free xbox3"}
pack .frame3.but1
#button .but1 -image $im1
#catch [button .but3 -image [base64 decode $im1]]
#image create photo but1image -data $im3 
#-file /file1255.gif
#image create photo but2image -data $im3
#image create photo buta3image -data $im10
#set but5i [image create photo but4image -data $im4]
#catch {puts hey; puts but1image}
#catch {puts he1; puts $but1image}
#button .but2 -image but1image
#pack .but2 
#update
#after 1000
#.but2 configure -image but2image
#update
#after 1000
#.but2 configure -image but4image
#update
#after 1000
#catch {.but2 configure -image $but5i}
#update
#after 1000
#.but2 configure -text "dat's all folks..." -command exit
#update
#after 100
...
#     catch {update}
#     if {$i % 2 == 0} {
#	     .but2 configure -text $i -command exit
#	     update
#     } else {
#	     .but2 configure -image buta3image -command {puts "hay cheeze"}
#	     update
#     }
#  }
#}
  ...
  set img1 [image create photo -data $j]
  	...
  	canvas .con1
  	.con1 create image 0 0 -anchor nw -image $img1
  	pack .con1
  	update
