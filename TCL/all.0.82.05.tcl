...
pack .f5; pack .f5.5off -side right; pack .f5.5 -side left;pack .f5.5on -side right;
#1
...
frame .t5.frame2; pack .frame2 -side left
button .t5.frame2.but1 -text but1 -command {puts im$i; tree$i $i}; pack .t5.frame2.but1
